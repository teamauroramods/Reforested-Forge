            ...
            if (configuredFeature.config instanceof DecoratedFeatureConfig) {
                ...
                if (decorated.feature.config instanceof MultipleRandomFeatureConfig) {
                    ...
                    for (ConfiguredRandomFeatureList crfl : tree.features) {
                        if (crfl.feature.feature instanceof TreeFeature) {if (crfl.feature.config == DefaultBiomeFeatures.BIRCH_TREE_CONFIG) {
                                tempFeatures.add(new ConfiguredRandomFeatureList<BaseTreeFeatureConfig>(ReforestedFeatures.BIRCH_TREE.withConfiguration(BIRCH_TREE_CONFIG), crfl.chance));
                                ...
                                tempFeatures.add(new ConfiguredRandomFeatureList<BaseTreeFeatureConfig>(ReforestedFeatures.TALL_BIRCH_TREE.withConfiguration(BIRCH_TREE_CONFIG), crfl.chance));
                            } else {
                    ...
                    if (tree.defaultFeature.feature instanceof TreeFeature) {
                        ...
                        ConfiguredFeature<BaseTreeFeatureConfig, ?> cfgdTree = new ConfiguredFeature<BaseTreeFeatureConfig, TreeFeature>((TreeFeature)tree.defaultFeature.feature, (BaseTreeFeatureConfig)tree.defaultFeature.config);
                    ...
                    ConfiguredFeature<BaseTreeFeatureConfig, ?> cfgdTree = new ConfiguredFeature<>((TreeFeature)decorated.feature.feature, (BaseTreeFeatureConfig)decorated.feature.config);
                    if (treeCfg == DefaultBiomeFeatures.BIRCH_TREE_CONFIG) {
                        cfgdTree = ReforestedFeatures.BIRCH_TREE.withConfiguration(BIRCH_TREE_CONFIG);
                    } else if (treeCfg == DefaultBiomeFeatures.field_230129_h_) {
                        cfgdTree = ReforestedFeatures.BIRCH_TREE.withConfiguration(BIRCH_TREE_CONFIG);
